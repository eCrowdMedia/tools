...
var _buildParentEntitlement = function(path, config)
{
    ...
    // 加入 Desktop App 需要的權限
    properties['com.apple.security.temporary-exception.files.home-relative-path.read-write'] = 
    [
        '/Library/Containers/com.readmoo.readmoodesktop/'
    ];

    properties['com.apple.security.temporary-exception.files.absolute-path.read-only'] = 
    [
        '/Applications/Readmoo 看書.app/'
    ];
    // 權限結束
